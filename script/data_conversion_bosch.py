# This is Chun Pook <pookc@hotmail.com>'s script to convert Bosch Traffic Light dataset to tfrecords.
#
# It was partial effort to improve traffic light state detection accracy by using the Bosch dataset:
